...
use crate::{FunctionStitchingGraph, MTL4FunctionDescriptor};
...
impl MTL4StitchedFunctionDescriptor {
    extern_methods!(
        ...
        pub unsafe fn functionGraph(&self) -> Option<Retained<FunctionStitchingGraph>>;
        ...
        #[unsafe(method_family = none)]
        pub unsafe fn setFunctionGraph(&self, function_graph: Option<&FunctionStitchingGraph>);
