...
/// Completion block signatures matching Metal APIs
pub type MTLNewLibraryCompletionHandler =
    *mut block2::DynBlock<dyn Fn(*mut ProtocolObject<dyn MTLLibrary>, *mut NSError)>;
pub type MTLNewDynamicLibraryCompletionHandler = *mut block2::DynBlock<
    dyn Fn(*mut ProtocolObject<dyn crate::dynamic_library::MTLDynamicLibrary>, *mut NSError),
>;
pub type MTLNewComputePipelineStateCompletionHandler = *mut block2::DynBlock<
    dyn Fn(*mut ProtocolObject<dyn crate::compute_pipeline::MTLComputePipelineState>, *mut NSError),
>;
pub type MTLNewRenderPipelineStateCompletionHandler = *mut block2::DynBlock<
    dyn Fn(*mut ProtocolObject<dyn crate::render_pipeline::MTLRenderPipelineState>, *mut NSError),
>;
