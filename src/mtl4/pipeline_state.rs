...
use objc2_foundation::{
    CopyingHelper, NSCopying, NSInteger, NSObjectProtocol, NSString, NSUInteger,
};
...
impl MTL4PipelineOptions {
    extern_methods!(
        ...
        pub unsafe fn shaderValidation(&self) -> ShaderValidation;

        /// Setter for [`shaderValidation`][Self::shaderValidation].
        #[unsafe(method(setShaderValidation:))]
        #[unsafe(method_family = none)]
        pub unsafe fn setShaderValidation(&self, shader_validation: ShaderValidation);
